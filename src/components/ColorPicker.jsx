...
const ColorPicker = ({selectedColor, onChange}) => {
  ...
  return (
    <div className='relative'>
      <button onClick={()=> setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-gray-950 bg-linear-to-br
       from-secondary to-accent ring-primary hover:ring transition-all px-3 py-2 rounded-lg'>
