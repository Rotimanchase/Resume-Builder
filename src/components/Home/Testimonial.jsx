...
const Testimonial = () => {
  ...
  return (
    <>
        <div id='testimonials' className='flex flex-col items-center scroll-mt-12 py-10'>
        <div className="flex items-center gap-2 text-sm text-primary bg-primary/10 rounded-full px-6">
            <BookUserIcon className='size-4.5 stroke-primary'/>
            <span>Testimonials</span>
        </div>
        <Title title="Don't just take our words" description="Hear what our users says about us. we're
        always looking for ways to improve. If you have a positive experience
